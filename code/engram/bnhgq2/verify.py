...
Gate 1 (rebuild ↔ trained): HGQ2-Keras scores vs the verified roc-results/reference experiment npz
on the held-out val split — Pearson corr + macro-OvR AUC + per-class AUC. Labels are
...
are the reference-model static+fold_csd2 measurements (LEDGER 2026-07-04).
